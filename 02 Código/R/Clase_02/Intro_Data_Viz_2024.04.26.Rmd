...
# Chunk Options
* include = FALSE 
(evita que el código y los resultados aparezcan en el archivo terminado. R Markdown aún ejecuta el código en el fragmento y los resultados pueden ser utilizados por otros fragmentos)

* echo = FALSE 
(evita que el código, pero no los resultados, aparezcan en el archivo terminado. Esta es una forma útil de incrustar figuras)

* message = FALSE 
(evita que los mensajes generados por código aparezcan en el archivo terminado)

* warning = FALSE 
(evita que las advertencias generadas por el código aparezcan en el final)

* fig.cap = "..." 
(agrega un título a los resultados gráficos)
